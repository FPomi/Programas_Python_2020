...
def edad_min():
    ...
    print('|------------------------------------------------------------------------------------------------------------|')
    print('|------------------------------------------------------------------------------------------------------------|')
    print("\t Por favor complete todas las caracteristicas antes de cambiar de menu")
    print('|------------------------------------------------------------------------------------------------------------|')
    print('|------------------------------------------------------------------------------------------------------------|')
    print(" Las edades legales son de 18 años a 99 años.\n - [A] Aleatorio")

    while type(edad_min) == str or int(edad_min) < EDAD_MIN or int(edad_min) > EDAD_MAX:
...
def edad_max():
    ...
    print('|------------------------------------------------------------------------------------------------------------|')
    print(" La edad máxima debe ser mayor o igual a la edad minima antes puesta y menor o igual a 99 años.\n - [A] Aleatorio")

    while type(edad_max) == str or int(edad_max) < EDAD_MIN or int(edad_max) > EDAD_MAX:
...
def radio_de_busqueda():
    ...
    while type(radio) == str or float(radio) < RADIO_MIN or float(radio) > RADIO_MAX:
...
def sexo_de_interes(): 
    ...
    while sexo.lower() not in sexos and sexo.lower() != "a" :
...
def mostrar_persona(datos, distancia, resultado_interes):
    nombre, apellido, contra, sexo_usuario, edad, ubicacion, intereses, likes, chats, _ = datos
