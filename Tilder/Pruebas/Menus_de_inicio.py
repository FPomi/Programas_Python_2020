...
### Del ingreso del usuario, vamos a extraer como dato su pseudónimo, porque nos va a servir para sacar información más adelante
    ...
    while pseudonimo_ingreso == "":
         pseudonimo_ingreso = input(" El pseudonimo no puede estar vacio, vuelva a intentar: ")
        
    contraseña_ingreso = input (" Contraseña: ")
    
    while contraseña_ingreso == "":
        contraseña_ingreso = input (" La contraseña no puede estar vacia, vuelva a intentar: ")
